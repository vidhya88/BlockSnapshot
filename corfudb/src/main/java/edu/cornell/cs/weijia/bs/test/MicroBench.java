...
public class MicroBench {
  ...
  private static void initialize(String bsimpl,boolean bSnapshot) throws BlockSnapshotException{
    ...
    if(bsimpl.equals("njhp"))
    	memBlock=MemBlock.createMemBlock(BlockImplement.JAVA_COW_HEAP,null);
    else if(bsimpl.equals("pjhp"))
    	memBlock=MemBlock.createMemBlock(BlockImplement.PAGE_COW_HEAP,null);
    else if(bsimpl.equals("pjap"))
    	memBlock=MemBlock.createMemBlock(BlockImplement.PAGE_COW_APP,null);
    else if(bsimpl.equals("base"))
      memBlock=MemBlock.createMemBlock(BlockImplement.BASELINE,null);
    else if(bsimpl.equals(""))
    	memBlock=MemBlock.createMemBlock(BlockImplement.PAGE_COW_JNI,null);
