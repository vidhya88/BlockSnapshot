...
public class functionalTest {
  ...
  MemBlock b = MemBlock.createMemBlock(BlockImplement.PAGE_COW_HEAP,null);
  ...
  public void correctTest(){
    MemBlock pjhp = MemBlock.createMemBlock(BlockImplement.PAGE_COW_HEAP,null);
    MemBlock njhp = MemBlock.createMemBlock(BlockImplement.JAVA_COW_HEAP,null);
